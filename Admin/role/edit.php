...
// query get by id and then sekt data in edit form(get data and set data in the form )
...
// ye mene edit button k id get k h url se
if (isset($_REQUEST['id'])) {
    $id = $_REQUEST['id'];
    $object =  new model_role();
    $result  = $object->get_sigle_id($id);
...
if (isset($_POST['update'])) {
    ...
    $updated_object =  new model_role();
    $result = $updated_object->update($role, $role_id);
    ...
    <div class="w-full max-w-md z-10">
        ...
        <div class="bg-slate-800/80 backdrop-blur-md border border-slate-700/50 rounded-3xl p-6 sm:p-8 shadow-2xl relative">
            ...
            <form action="edit.php" method="POST" class="space-y-6">
                <input type="hidden" name="role_id" value="<?php echo isset($val['id']) ? $val['id'] : ''; ?>">
                <!-- Input Group -->
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        ...
                        <input
                            ...
                            id="role_name"
                            name="role_name"
                            value="<?php echo isset($val['role_name']) ? $val['role_name'] : ''; ?>"
                ...
                <button
                    ...
                    <i class="fa-solid fa-floppy-disk text-xs"></i> update role
                </button>
            </form>
