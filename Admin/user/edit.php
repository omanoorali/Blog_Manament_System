<?php
// url/ query strign se user k id get karna.
...
if (isset($_REQUEST['id'])) {
    ...
    //  echo $id;
    $users_data = new User();
    $result = $users_data->get_single_user($id);
    ...
    if ($result) {
        ...
        echo "Database mein is ID ka koi user nahi hai!";
    }
}
...
if (isset($_POST['update'])) {
    ...
    if(isset($_FILES['profile_image']) && $_FILES['profile_image']['error']=== 0){
        ...
        // Image ka unique naam banayein taake duplicate na ho
        $profile_image = time() . "_" . $image_name;
        
        // Image ko folder mein move karein
        move_uploaded_file($tmp_name, "../../uploads/" . $profile_image);
        
        // Agar purani image folder mein maujood hai toh use delete (unlink) kar dein (optional but good)
    ...
    $users_data = new User();
    $result=$users_data->update($name, $email, $password, $phone_number, $profile_image, $role_id, $id);
        ...
        <input type="hidden" name="id" value="<?php echo isset($id)? $id:'' ?>">
            ...
            <div class="space-y-1.5">
                ...
                <div class="relative group">
                    ...
                    <input type="text" id="name" value="<?php echo  isset($name) ? $name : ''; ?>" name="name" placeholder=""
            ...
            <div class="space-y-1.5">
                ...
                <div class="relative group">
                    ...
                    <input type="email" id="userEmail" value="<?php echo isset($email) ? $email : ''; ?>" name="email" placeholder="ahmad@blogify.com"
                        class="w-full bg-slate-50 border border-slate-200 focus:border-indigo-500 focus:bg-white rounded-2xl pl-11 pr-4 py-3.5 text-sm text-slate-800 placeholder-slate-400 outline-none focus:ring-4 focus:ring-indigo-500/10 transition-all duration-200">
                </div>
            </div>
            ...
            <div class="space-y-1.5">
                ...
                <div class="relative group">
                    ...
                    <input type="password" id="userPassword" value="<?php echo isset($password) ? $password : ''; ?>" name="password" placeholder="••••••••"
            ...
            <div class="space-y-1.5">
                ...
                <div class="relative group">
                    <input type="text" id="phone_number" name="phone_number" value="<?php echo  isset($phone_number) ? $phone_number : ''; ?>" placeholder="9203124547845"
                        class="w-full bg-slate-50 border border-slate-200 focus:border-indigo-500 focus:bg-white rounded-2xl pl-11 pr-4 py-3.5 text-sm text-slate-800 placeholder-slate-400 outline-none focus:ring-4 focus:ring-indigo-500/10 transition-all duration-200">
                </div>
            </div>
            ...
            <div class="space-y-1.5">
                ...
                <div class="relative group">
                    <img src="../../uploads/<?php echo isset($profile_image) ? $profile_image : ''; ?>"
                        alt="Profile Image"
                        style="width: 60px; height: 60px; border-radius: 50%; object-fit: cover;">

                    <input type="hidden" name="old_image" value="<?php echo isset($profile_image) ? $profile_image : ''; ?>">
                ...
                <div class="relative group">
                    ...
                    <select id="role_name" name="role_name"
                        ...
                        <?php while ($roles = mysqli_fetch_assoc($results)) { ?>
                            <option value="<?php echo $roles['id']; ?>" <?php echo ($roles['id'] == $role_ids) ? "selected" : '' ?>>
